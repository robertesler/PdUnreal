...
#ifndef PdRainSourceParams_H
#define PdRainSourceParams_H
...
struct PdRainSourceParams
    : public AK::IAkPluginParam
{
    PdRainSourceParams();
    PdRainSourceParams(const PdRainSourceParams& in_rParams);
    ...
    PdRainRTPCParams RTPC;
    PdRainNonRTPCParams NonRTPC;
};

#endif // PdRainSourceParams_H
